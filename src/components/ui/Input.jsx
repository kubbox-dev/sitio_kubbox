...
export function Input({ label, icon: Icon, className = '', value, ...props }) {
  ...
  return (
    <div className={cn('relative', className)}>
      {Icon && (
        <Icon
          size={16}
          className="absolute left-0 top-1/2 -translate-y-1/2 pointer-events-none transition-colors duration-200"
      ...
      <input
        ...
        {...props}
        className={cn(
          'outline-none border-b-2 border-[var(--c-ink)]/30 py-2 w-full text-base font-medium text-[var(--c-ink)] bg-transparent placeholder-transparent transition-colors duration-200 focus:border-[var(--c-lime)]',
          Icon && 'pl-6'
        )}
      />
