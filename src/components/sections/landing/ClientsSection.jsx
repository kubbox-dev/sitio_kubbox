...
const CLIENTS = [
  ...
  {
    name: "Chocolisto",
    src: "/images/HOME/WEB/Logos/chocolisto logo.svg",
    filter: "invert(1) grayscale(1)",
  },
  {
    name: "Corona",
    src: "/images/HOME/WEB/Logos/corona logo.svg",
    filter: "invert(1) grayscale(1)",
  },
  {
    name: "Centro Automotriz",
    src: "/images/HOME/WEB/Logos/centro automotriz logo.svg",
  },
  ...
  return (
    <motion.div
      ...
      transition={{
        ...
        duration: 35,
        ease: "linear",
        delay: offset < 0 ? Math.abs(offset) : 0,
      }}
      style={{
        display: "flex",
        alignItems: "center",
