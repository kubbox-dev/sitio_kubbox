...
const PHOTOS = [
  "/images/Servicios/hosting-empresarial/hosting.webp",
  "/images/Servicios/hosting-empresarial/slider 2_6.webp",
];
...
const DEFAULT_BULLETS = [
  ...
  {
    icon: encodeURI(
      "/images/Servicios/hosting-empresarial/Certificados ssl.svg",
    ),
