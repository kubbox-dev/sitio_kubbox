...
const DEFAULT_BULLETS = [
  ...
  {
    icon: encodeURI(
      "/images/Servicios/automatizacion-whatsapp/Automatizacion de respuestas.svg",
    ),
    label: "Automatización de respuestas",
  },
  {
    icon: encodeURI(
      "/images/Servicios/automatizacion-whatsapp/Atencion al cliente.svg",
    ),
    label: "Atención al cliente",
  },
  {
    icon: encodeURI(
      "/images/Servicios/automatizacion-whatsapp/Notificaciones automaticas.svg",
    ),
