...
export default function DigitalHeroSection({ title }) {
  ...
  const line1 = words ? words.slice(0, mid).join(" ") : "CREACIÓN Y";
  const line2 = words ? words.slice(mid).join(" ") : "DESARROLLO DE MARCA";
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="/images/Servicios/creacion-desarrollo-marca/arriba_6.webp"
          alt=""
          className="
            absolute
            right-[-10%]
        ...
        <img
          src="/images/Servicios/creacion-desarrollo-marca/abajo_6.webp"
          alt=""
          className="
            absolute
            left-[13%]
