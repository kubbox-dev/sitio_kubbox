...
const DEFAULT_BULLETS = [
  {
    icon: encodeURI(
      "/images/Servicios/campanas-digitales/Cadenas comerciales.svg",
    ),
    label: "Cadenas comerciales",
  },
  {
    icon: encodeURI(
      "/images/Servicios/campanas-digitales/centros comerciales.svg",
    ),
    label: "Centros comerciales",
  },
  {
    icon: encodeURI(
      "/images/Servicios/campanas-digitales/Grandes superficies.svg",
    ),
    label: "Grandes superficies",
  },
  {
    icon: encodeURI(
      "/images/Servicios/campanas-digitales/Marcas de consumo masivo.svg",
    ),
