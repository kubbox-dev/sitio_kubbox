...
export default function DigitalHeroSection({ title }) {
  ...
  const line1 = words ? words.slice(0, mid).join(" ") : "POSICIONAMIENTO";
  const line2 = words ? words.slice(mid).join(" ") : "SEO";
  ...
  return (
    ...
    >
      ...
      >
        {/* TRIÁNGULO SUPERIOR */}
        <img
          src="/images/Servicios/posicionamiento-SEO/arriba_4.webp"
          alt=""
          className="
            absolute
            right-[-10%]
        ...
        {/* TRIÁNGULO INFERIOR */}
        <img
          src="/images/Servicios/posicionamiento-SEO/abajo_4.webp"
          alt=""
          className="
            absolute
            left-[13%]
