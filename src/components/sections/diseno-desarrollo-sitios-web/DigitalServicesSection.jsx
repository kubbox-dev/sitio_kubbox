...
const PHOTOS = [
  "/images/Servicios/diseno-desarrollo-sitios-web/slider 1.webp",
  "/images/Servicios/diseno-desarrollo-sitios-web/slider 2.webp",
];
...
const DEFAULT_BULLETS = [
  {
    icon: encodeURI(
      "/images/Servicios/diseno-desarrollo-sitios-web/Sitios web corporativos.svg",
    ),
    label: "Sitios web corporativos",
  },
  {
    icon: encodeURI(
  ...
  {
    icon: encodeURI(
      "/images/Servicios/diseno-desarrollo-sitios-web/Plataformas web personalizadas.svg",
    ),
    label: "Plataformas web personalizadas",
  },
  {
    icon: encodeURI(
      "/images/Servicios/diseno-desarrollo-sitios-web/tiendas virtuales.svg",
    ),
...
const SUB_BULLETS = [
  ...
  "Plataformas autoadministrables",
