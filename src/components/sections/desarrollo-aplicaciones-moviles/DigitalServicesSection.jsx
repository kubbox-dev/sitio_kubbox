...
const DEFAULT_BULLETS = [
  ...
  {
    icon: encodeURI(
      "/images/Servicios/aplicaciones-moviles/Comercio electronico.svg",
    ),
    label: "Comercio electrónico",
  },
  {
    icon: encodeURI(
      "/images/Servicios/aplicaciones-moviles/Equipos comerciales.svg",
    ),
...
const SUB_BULLETS = ["Empresas", "Servicios", "Logística", "Gestión interna"];
